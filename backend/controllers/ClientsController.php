...
class ClientsController extends Controller
{
    ...
    protected function findModel($id)
    {
        ...
        {
            if (($model = Clients::find()->where('id='.Yii::$app->user->identity->client_id.' OR id IN (SELECT id FROM clients where parent_id='.Yii::$app->user->identity->client_id)->one() !== null)) {
                $model = Clients::find()->where('id='.Yii::$app->user->identity->client_id.' OR id IN (SELECT id FROM clients where parent_id='.Yii::$app->user->identity->client_id)->one();
                return $model;
            }
        }else{
            if (($model = Clients::findOne($id)) !== null) {
